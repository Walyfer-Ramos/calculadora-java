...
public class Memoria {
	...
	private enum TipoComando {
			ZERAR, NUMERO, DIV, MULT, SUB, SOMA, IGUAL , VIRGULA, SINAL, PORCENT;
	};
	...
	private String obterResultadoOperacao() {
		...
		String resultadoSting = Double.toString(resultado).replace(".", ",");
		boolean inteiro = resultadoSting.endsWith(",0");
		return inteiro ? resultadoSting.replace(",0", "") 
				: resultadoSting;
	}
